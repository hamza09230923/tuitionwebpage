        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center">
            ...
            <p className="text-lg text-gray-600 mb-8 max-w-2xl mx-auto">
              One-to-one personalized lessons with expert tutors. Your child only sees the teacher - no distractions, maximum focus.
            </p>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center p-6 bg-blue-50 rounded-lg">
              ...
              <p className="text-gray-600">Convenient online lessons from the comfort of your home. High-quality video and interactive whiteboard.</p>
            </div>
            <div className="text-center p-6 bg-blue-50 rounded-lg">
              <div className="bg-blue-600 w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-4">
              ...
              <p className="text-gray-600">Your child only sees the teacher. Private, secure sessions designed for maximum learning focus.</p>
            </div>
          </div>
        </div>
      </section>
            ...
            {[
              {
                ...
                a: 'Each lesson is conducted one-to-one via Zoom. Your child will see only the teacher, ensuring privacy and focus. We use interactive whiteboards and screen sharing to make lessons engaging and effective. All sessions are recorded for your child to review later.'
              },
              {
                q: 'What equipment do we need?',
                a: 'You just need a computer, tablet, or laptop with a webcam and microphone, plus a stable internet connection. We recommend using a desktop or laptop for the best experience with the interactive whiteboard.'
              },
              {
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose max-w-none text-gray-600 space-y-6">
            ...
            <div>
              ...
              <p>You are responsible for ensuring you have adequate internet connection and equipment for Zoom sessions. We are not liable for technical issues on your end, though we'll do our best to accommodate.</p>
            </div>
            <div>
