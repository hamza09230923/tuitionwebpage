  ...
  return (
    <main className="min-h-screen bg-gray-50 px-4 py-16 sm:px-6 lg:px-8">
      <article className="mx-auto max-w-4xl rounded-2xl bg-white p-8 shadow-sm sm:p-12">
        ...
        <p className="mt-3 text-sm text-gray-500">Last updated: 15 August 2026</p>
        <div className="mt-10 space-y-8 text-gray-600">
          ...
          <section><h2 className="text-2xl font-semibold text-gray-900">3. Refund Eligibility</h2><p className="mt-3">Refunds are only available when you cancel a lesson at least 24 hours before the scheduled lesson time. If you don't cancel at least 24 hours before a lesson, miss a lesson or do not attend, that lesson is not refundable.</p></section>
          ...
          <section><h2 className="text-2xl font-semibold text-gray-900">5. Cancellation</h2><p className="mt-3">You may cancel at any time. Access remains active until the end of the paid billing period, and cancellation applies to future billing periods.</p></section>
          <section><h2 className="text-2xl font-semibold text-gray-900">6. How to Cancel or Request a Refund</h2><p className="mt-3">Submit your request in writing by WhatsApp or SMS to +44 7344 193804. Include the student's full name, the email address or phone number used to register and a clear description of your request.</p></section>
          <section><h2 className="text-2xl font-semibold text-gray-900">7. Digital Services and Fair Use</h2><p className="mt-3">Access to lessons, recordings and resources may begin shortly after payment. MySchola may refuse requests involving repeated abuse, misuse, fraud or bad-faith use of the refund policy. This does not affect your statutory rights.</p></section>
